...
# Install airflow using regular 'pip3 install' command. This install airflow depending on the arguments:
...
function install_airflow() {
    ...
    if [[ "${UPGRADE_TO_NEWER_DEPENDENCIES}" != "false" ]]; then
        ...
        echo
        # eager upgrade
        pip3 install ${AIRFLOW_INSTALL_USER_FLAG} --upgrade --upgrade-strategy eager \
